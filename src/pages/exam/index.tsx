        ...
        <div className={cx("wide")}>
          <div className={cx("exam__wrapper")}>
            <div className={cx("exam__container")}>
              <div className={cx("exam__breadcumb")}>
              ...
              <h1 className={cx("exam__heading")}>
                Đề kiểm tra cuối học kì 2 môn Vật Lý 12 - Đề số 1
              </h1>

              <Row gutter={10} className={cx("exam__view")}>
                <Col xl={16} lg={16} md={24} sm={24} xs={24}>
                  <Row
                    className={
                      clockStick
                        ? cx("exam__clock--panel", "stick")
                        : cx("exam__clock--panel")
                    }
                    onScroll={handleClockStick}
                  >
                    <FaRegClock className={cx("exam__clock--icon")} />
                    <span className={cx("exam__clock--time")}>00:47:43</span>
                  </Row>

                  <div>
                    <Row className={cx("exam__practice")}>
                      <div className={cx("exam__practice--item")}>
                ...
                <Col xl={8} lg={8} md={0} sm={0} xs={0}>
                  <div className={cx("exam__palette--panel")}>
                    <div className={cx("exam__palette--main")}>
                      <div className={cx("exam__p alette--header")}>
                        <div className={cx("exam__palette--title")}>
                          Bảng câu hỏi
                        </div>
                      </div>
                      <div className={cx("exam__palette--body")}>
                        <div className={cx("exam__palette--progress")}>
                          <Progress
                            percent={50}
                            status="active"
                            strokeColor={"#009d9d"}
                            showInfo={false}
                          />
                          <div className={cx("exam__palette--progress-title")}>
                            20/40
                          </div>
                        </div>

                        <div className={cx("exam__palette--question-list")}>
                          <Row
                            style={{
                              marginTop: "0.4rem",
                            }}
                      ...
                      <div className={cx("exam__palette--footer")}>
              ...
              <div className={cx("exam__subnav")}>
                <div className={cx("exam__subnav--main")}>
                  <div className={cx("exam__subnav--item")}>
                    <FaRegPauseCircle
                      className={cx("exam__subnav--item-icon")}
                    />
                    <div className={cx("exam__subnav--item-label")}>
                      Tạm dừng
                    </div>
                  </div>
                  <div
                    className={
                      openQuestionList
                        ? cx("exam__subnav--item", "active")
                        : cx("exam__subnav--item")
                    }
